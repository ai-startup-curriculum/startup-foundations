# Ai Startup · Startup Foundations — Learning Repository
...
Curriculum for the Startup Foundations role.
...
[`startup-foundations`](https://github.com/ai-startup-curriculum/startup-foundations) carries the reference implementations.
